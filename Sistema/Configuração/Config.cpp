...
void Config::load(string pathConfig){
    ...
    /// DEFINIÇÕES DO CAMPO
    COMPRIMENTO_CAMPO = 9000.0;   //  COMPRIMENTO_CAMPO = 6050.0;
    LARGURA_CAMPO = 6000.0;     // LARGURA_CAMPO = 4050.0;
    MEIO_COMPRIMENTO_CAMPO = COMPRIMENTO_CAMPO/2.0;
    MEIA_LARGURA_CAMPO = LARGURA_CAMPO/2.0;
    COMPRIMENTO_GOL = 1000.0;
    MEIO_COMPRIMENTO_GOL = 500.0;
    RAIO_SEMI_CIRCULO_AREA = 1000.0;
    MEIA_LARGURA_SEGMENTO_AREA = 250.0;
